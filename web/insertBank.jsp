            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/SsmDemo/insertBank" method="post">
                            <%--                            --%>
                            <div class="form-group row">
                                <label for="colFormLabelSm">&nbsp&nbsp&nbsp&nbsp银行名称</label>
                                <div class="col-sm-10">
                                    <input type="text" name="name"
                                           class="form-control"  id="colFormLabelSm"  value="${bank.name}"
                                           placeholder="Enter name">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabel" >&nbsp&nbsp&nbsp&nbsp银行类型</label>
                                <div class="col-sm-10">
                                    <input type="text" name="type"  value="${bank.type}"
                                           class="form-control" id="colFormLabel"
                                           placeholder="Enter type">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="CarFormLabelLg">&nbsp&nbsp&nbsp&nbsp银行资产</label>
                                <div class="col-sm-10">
                                    <input type="text" name="assets"
                                           class="form-control"  id="CarFormLabelLg"  value="${bank.assets}"
                                           placeholder="Enter assets">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabelLg">&nbsp&nbsp&nbsp&nbsp银行描述</label>
                                <div class="col-sm-10">
                                    <input type="text" name="bankdesc" class="form-control"
                                           id="colFormLabelLg" value="${bank.bankdesc}"
