...
<nav class="navbar">
    <div class="container-fluid">
        ...
        <div class="header-body">
            ...
            <%--       搜索的表单、包含分页跳转查询     --%>
            <form id="search" action="/SsmDemo/queryBankcard" class="search">
    ...
    <div class="container-fluid">
        ...
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <c:if test="${nowUser!=null}">
                <h4>${sessionScope.name}的银行卡</h4>
            </c:if>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    <li class="breadcrumb-item active" aria-current="page">当前登陆:${sessionScope.name}</li>
                </ol>
            </nav>
        </div>
        <!-- end::page header -->
...
<%--                                    <th scope="col">id</th>--%>
                                    ...
                                    <th scope="col">所属银行</th>
                                    <th scope="col">类型</th>

<%--                                    <th scope="col">银行卡所属用户</th>--%>
                                    <th scope="col">金额</th>
                                ...
                                <%--        items表示为数据源        var临时变量                --%>
<%--                                <c:if test="${userItem.banke.name==sessionScope.name}">--%>
<%--                                    --%>
<%--                                </c:if>--%>
                                ...
                                <c:forEach items="${list}" var="userItem">
                                    <c:if test="${userItem.user.username==sessionScope.name}">
                                        ...
                                        <tr>
                                            <td>${userItem.cardnum}</td>
<%--                                        <th scope="row">${userItem.id}</th>--%>
                                        <td>${userItem.banke.name}</td>
                                        <td>
                                            <c:if test="${userItem.type==1}">
                                                借记卡
                                            </c:if>
                                            <c:if test="${userItem.type==2}">
                                                信用卡
                                            </c:if>
                                        </td>
...
<%--                                        <td>${userItem.user.username}</td>--%>
                                        ...
                                        <td>
                                            <c:if test="${userItem.defaultl==1}">
                                                默认
                                            </c:if>
                                            <c:if test="${userItem.defaultl==2}">
                                                不默认
                                            </c:if>
                                        </td>
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="/SsmDemo/deleteBankcard?id=${userItem.id}">
                                                        <button class="dropdown-item" type="button">销户</button>
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a href="/SsmDemo/toUpdateBankcard?id=${userItem.id}">
                                                                <button class="dropdown-item" type="button">修改</button>
                                                            </a>
                                                            <a href="/SsmDemo/deleteBankcard?id=${userItem.id}">
