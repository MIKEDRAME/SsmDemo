...
<nav class="navbar">
   <div class="container-fluid">
      ...
      <div class="header-body">
         ...
         <%--       搜索的表单、包含分页跳转查询     --%>
         <form id="search" action="/SsmDemo/queryUserFundProduct" class="search">
                     ...
                     <table class="table">
                        ...
                        <c:forEach items="${list}" var="userItem">
                           ...
                           <tr>
                              ...
                              <td>${userItem.fundproduct.funddesc}</td>
                              <td>${userItem.starttime}</td>
                              <td>${userItem.endtime}</td>

                              <td>
                                 <c:if test="${userItem.status==1}">
                                    持有中
                                 </c:if>
                                 <c:if test="${userItem.status==2}">
                                    已失效
                                 </c:if>
                                 <c:if test="${userItem.status==3}">
                                    已撤销
                                 </c:if>
                              </td>
                              <td class="text-right">
                                 <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                       <a href="/SsmDemo/toUpdateUserFundProduct?id=${userItem.id}">
                                          <button class="dropdown-item" type="button">修改</button>
                                       </a>
                                       <a href="/SsmDemo/deleteUserFundProduct?id=${userItem.id}">
