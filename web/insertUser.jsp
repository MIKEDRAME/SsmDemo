                    ...
                    <div class="card-body">
                        ...
                        <form action="/SsmDemo/register" method="post">
                            ...
                            <div class="form-group mb-4">
                                <label>用户名</label>
                                <input type="text" name="username" class="form-control form-control-lg" autofocus placeholder="Username,varchar(20)">
                            </div>
                            <div class="form-group mb-4">
                                <label>邮箱</label>
                                <input type="email" name="email" class="form-control form-control-lg" placeholder="Email,varchar(20)">
                            </div>
                            <div class="form-group mb-4">
                                <div class="form-group mb-4">
                                    <label>密码</label>
                                    <input type="password" name="password" class="form-control form-control-lg" placeholder="Password,varchar(40)">
                                </div>
                            </div>
