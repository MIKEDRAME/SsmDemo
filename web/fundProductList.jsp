...
<nav class="navbar">
    <div class="container-fluid">
        ...
        <div class="header-body">
            ...
            <%--       搜索的表单、包含分页跳转查询     --%>
            <form id="search" action="/SsmDemo/queryFundProduct" class="search">
                                ...
                                <c:forEach items="${list}" var="userItem">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <c:if test="${userItem.type==3}">
                                                货币型基金
                                            </c:if>
                                            <c:if test="${userItem.type==4}">
                                                混合型基金
                                            </c:if>
                                        </td>
                                        <td>${userItem.dailygrowth}</td>
                                        <td>${userItem.leastmoney}</td>
                                        <td>${userItem.profit}</td>
                                        <td>${userItem.investerm}</td>
                                        <td class="text-right">
                                            <button type="button"
                                                    onclick="selectedFund('${userItem.id}','${userItem.funddesc}')"
