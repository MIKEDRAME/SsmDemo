...
<%--                    <h5 class="card-title"></h5>--%>
                    <form action="/SsmDemo/updateBankcard" method="post">
                        <%--          添加id隐藏域              --%>
                        <input type="hidden" name="id" value="${updateBankcard.id}">
                        <%--          添加id隐藏域              --%>
                            <div class="form-group mb-4">
                                <label>&nbsp所属银行</label>
                                <select name="cardbank" class="form-control form-control-lg" >

                                    <c:forEach items="${banks}" var="bankItem">
                                    <option
                                            <c:if test="${bankItem.id==updateBankcard.cardbank}">selected</c:if>
                                            value="${bankItem.id}">${bankItem.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="form-group mb-4"><label>&nbsp类型</label>
                                <select name="type" class="form-control form-control-lg"  >

                                    <option
                                            <c:if test="${updateBankcard.type==1}">selected</c:if>
                                            value="1">借记卡</option>
                                    <option
                                            <c:if test="${updateBankcard.type==2}">selected</c:if>
                                            value="2">信用卡</option>
                                </select>
                            </div>
                            <div class="form-group mb-4"><label>&nbsp卡号</label>
                                <div class="form-group mb-4">
                                    <input type="text" name="cardnum" class="form-control form-control-lg" value="${updateBankcard.cardnum}">
                                </div>
                            </div>
                            <div class="form-group mb-4"><label>&nbsp用户id</label>
                                <div class="form-group mb-4">
                                    <input type="text" name="userid" class="form-control form-control-lg" value="${updateBankcard.userid}">
                                </div>
                            </div>
                            <div class="form-group mb-4"><label>&nbsp金额</label>
                                <div class="form-group mb-4">
                                    <input type="text" name="balance" class="form-control form-control-lg" value="${updateBankcard.balance}">
                                </div>
                            </div>
                            <div class="form-group mb-4"><label>&nbsp是否默认</label>
                                <div class="form-group mb-4">
                                    <select name="defaultl" class="form-control form-control-lg"  >
                                        <option
                                                <c:if test="${updateBankcard.defaultl==1}">selected</c:if>
                                                value="1">默认</option>
                                        <option
                                                <c:if test="${updateBankcard.defaultl==2}">selected</c:if>
                                                value="2">不默认</option>
                                    </select>
                                </div>
                            </div>
