...
<%--    adminTitleLogo  end    --%>
        ...
        <div class="header-body">
            ...
            <%--       搜索的表单、包含分页跳转查询     --%>
            <form id="search" action="/SsmDemo/query" class="search">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="/SsmDemo/toUpdateUser?id=${userItem.id}"> <button class="dropdown-item" type="button">修改</button></a>
                                                    <a href="/SsmDemo/deleteUser?id=${userItem.id}"> <button class="dropdown-item" type="button">删除</button></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
