...
<nav class="navbar">
    <div class="container-fluid">
        ...
        <jsp:include page="TitleLogo.jsp"></jsp:include>
        <%--    adminTitleLogo  end    --%>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-body">
                    ...
                    <form action="/SsmDemo/updateFundProduct" method="post">
                        <%--          添加id隐藏域              --%>
                        <input type="hidden" name="id" value="${updateFundProduct.id}">
                        <%--          添加id隐藏域              --%>
<%--                        <div class="form-group mb-4">--%>
<%--                            <label >基金类型</label>--%>
<%--                            <select name="type" class="form-control form-control-lg" >--%>

<%--                                <c:forEach items="${fundProducts}" var="fundProductItem">--%>
<%--                                    <option--%>
<%--                                            <c:if test="${fundProductItem.id==updateFundProduct.type}">selected</c:if>--%>
<%--                                            value="${fundProductItem.id}">${fundProductItem.name}</option>--%>
<%--                                </c:forEach>--%>
<%--                            </select>--%>
<%--                        </div>--%>
                        <div class="form-group mb-4">
                            ...
                            <select name="type" class="form-control form-control-lg"  >
                                <option
                                        <c:if test="${updateFundProduct.type==1}">selected</c:if>
                                        value="1">股票型基金</option>
                                <option
                                        <c:if test="${updateFundProduct.type==2}">selected</c:if>
                                        value="2">债券型基金</option>
                                <option
                                        <c:if test="${updateFundProduct.type==3}">selected</c:if>
                                        value="3">货币型基金</option>
                                <option
                                        <c:if test="${updateFundProduct.type==4}">selected</c:if>
                                        value="4">混合型基金</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group mb-4">
                            <div class="form-group mb-4">
                                <label >基金代码</label>
                                <input type="text" name="code" class="form-control form-control-lg" value="${updateFundProduct.code}">
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <div class="form-group mb-4">
                                <label >基金简称</label>
                                <input type="text" name="funddesc" class="form-control form-control-lg" value="${updateFundProduct.funddesc}">
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <div class="form-group mb-4">
                                <label >日增长率</label>
                                <input type="text" name="dailygrowth" class="form-control form-control-lg" value="${updateFundProduct.dailygrowth}">
                            </div>
                        </div>
<%--                            --%>
                            <div class="form-group mb-4">
                                <div class="form-group mb-4">
                                    <label >起投金额</label>
                                    <input type="text" name="leastmoney" class="form-control form-control-lg" value="${updateFundProduct.leastmoney}">
                                </div>
                            </div>
                            <div class="form-group mb-4">
                                <div class="form-group mb-4">
                                    <label >收益</label>
                                    <input type="text" name="profit" class="form-control form-control-lg" value="${updateFundProduct.profit}">
                                </div>
                            </div>
                            <div class="form-group mb-4">
                                <div class="form-group mb-4">
                                    <label >投资期限</label>
                                    <input type="text" name="investerm" class="form-control form-control-lg" value="${updateFundProduct.investerm}">
                                </div>
                            </div>

                            <button type="submit" class="btn btn-primary btn-lg btn-block btn-uppercase mb-4">修改</button>
                    </form>
                </div>
            </div>
        </div>
