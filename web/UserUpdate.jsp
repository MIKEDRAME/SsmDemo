...
<%--                    <h5 class="card-title"></h5>--%>
                    <form action="/SsmDemo/updateUser" method="post">
                        <%--          添加id隐藏域              --%>
                        <input type="hidden" name="id" value="${updateUser.id}">
                        <%--          添加id隐藏域              --%>
                        <div class="form-group">
                            <label for="exampleInputEmail1">用户名</label>
                            <input type="text" name="username" value="${updateUser.username}" class="form-control"  placeholder="Enter name">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">密码</label>
                            <input type="text" name="password" value="${updateUser.password}"  class="form-control" id="exampleInputPassword1" placeholder="Enter Password">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">邮箱</label>
                            <input type="email" name="email" value="${updateUser.email}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="idcard" value="${updateUser.idcard}" class="form-control"  placeholder="idcard">
                        </div>
