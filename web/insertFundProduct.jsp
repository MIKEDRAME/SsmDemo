            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/SsmDemo/insertFundProduct" method="post">
                            <%--                            --%>
...
<%--                                               id="colFormLabelLgid" value="${fundProduct.id}"--%>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="code" class="form-control"
                                           id="CarFormLabelLg" value="${fundProduct.code}"
                                           placeholder="Enter   code，int(10)">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabelLg"
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="funddesc" class="form-control"
                                           id="colFormLabelLg" value="${fundProduct.funddesc}"
                                           placeholder="Enter   funddesc，varchar(255)">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabelLg"
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="dailygrowth" class="form-control"
                                           id="colFormbalance" value="${fundProduct.dailygrowth}"
                                           placeholder="Enter   dailygrowth，decimal(10,8)">
                                </div>
                            </div>
                                <div class="form-group row">
                                    <label for="colFormLabelLg"
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="leastmoney" class="form-control"
                                               id="colFormbalancel" value="${fundProduct.leastmoney}"
                                               placeholder="Enter   leastmoney，decimal(10,2)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="colFormLabelLg"
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="profit" class="form-control"
                                               id="colFormbalancep" value="${fundProduct.profit}"
                                               placeholder="Enter    profit，decimal(10,2)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="colFormLabelLg"
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="investerm" class="form-control"
                                               id="colFormbalancei" value="${fundProduct.investerm}"
                                               placeholder="Enter   investerm，varchar(20)">
                                    </div>
                                </div>
