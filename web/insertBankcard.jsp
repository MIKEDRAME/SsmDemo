            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/SsmDemo/insertBankcard" method="post">
                            <%--                            --%>
                            <div class="form-group row">
                                <label for="colFormLabelSm"
                                       class="col-sm-2 col-form-label col-form-label-sm">所属银行</label>
                                <div class="col-sm-10">
                                    <select name="cardbank" class="form-control form-control-sm"
                                            id="colFormLabelSm">
                                        <c:forEach items="${banks}" var="bankItem">
                                            <option value="${bankItem.id}">${bankItem.name}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="CarFormLabelLg"
                                       class="col-sm-2 col-form-label">银行卡号</label>
                                <div class="col-sm-10">
                                    <input type="text" name="cardnum" class="form-control"
                                           id="CarFormLabelLg" value="${bankCard.cardnum}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="userid" class="form-control"
                                           id="colFormLabelLg" value="${bankCard.userid}"
                                           placeholder="Enter userid">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabelLg"
                                       class="col-sm-2 col-form-label">金额</label>
                                <div class="col-sm-10">
                                    <input type="text" name="balance" class="form-control"
                                           id="colFormbalance" value="${bankCard.balance}"
                                           placeholder="Enter balance">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabelLg"
                                       class="col-sm-2 col-form-label">是否默认</label>
                                <div class="col-sm-10">
                                    <select name="defaultl" class="form-control form-control-sm"
                                            id="colFormdefaultl">
