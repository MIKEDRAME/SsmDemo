...
<div class="side-menu">
    <div class='side-menu-body'>
        <ul>
            ...
            <%--     个人中心       --%>
            <li class="open">
                <a href="#"><i class="icon ti-face-smile"></i> <span>用户模块</span> </a>
                <ul>
            ...
            <li class="open">
                <a href="#"><i class="icon ti-rocket"></i> <span>基金理财产品模块</span> </a>
                <ul>
            ...
            <li class="open">
                <a href="#"><i class="icon ti-pie-chart"></i> <span>用户投资基金模块</span> </a>
                <ul>

                    <li><a href="../userQueryUserFundProduct">我的投资基金</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="header-logo">
            <a href="#">
                ...
                <span class="logo-text d-none d-lg-block">银行客户端</span>
            </a>
        </div>
...
<main class="main-content">
    ...
    <div class="container-fluid">
        ...
        <div class="card-group">
            <div class="card">
                <img src="../assets/media/image/portfolio-six.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="card">
                <img src="../assets/media/image/portfolio-four.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Card title</h5>
            ...
            <div class="card">
                <img src="../assets/media/image/portfolio-two.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to
        ...
        <div class="card-columns">
            ...
            <div class="card">
                <img src="../assets/media/image/portfolio-one.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="card">
                ...
                <img src="../assets/media/image/portfolio-three.jpg" class="card-img-top" alt="...">
            </div>

            <div class="card bg-dark text-white">
                <img src="../assets/media/image/portfolio-six.jpg" class="card-img" alt="...">
            ...
            <div class="card">
                <img src="../assets/media/image/portfolio-five.jpg" class="card-img-top" alt="...">
            </div>
