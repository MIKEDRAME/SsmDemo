                        ...
                        <li class="list-group-item d-flex p-l-r-0">
                            ...
                            <div>
                                <p class="m-b-0">
                                    ...
                                    New userFundProduct registration.
                                </p>
                ...
                <div>
                    ...
                    <ul class="list-group list-group-flush m-b-10">
                        <li class="list-group-item d-flex p-l-r-0">
                            ...
                            <div>
                                <p class="m-b-0">New userFundProduct registration.</p>
                                <ul class="list-inline small">
...
<nav class="navbar">
    <div class="container-fluid">
        ...
        <jsp:include page="userTitleLogo.jsp"></jsp:include>
        <%--    adminTitleLogo  end    --%>
        ...
        <div class="header-body">
            ...
            <%--       搜索的表单、包含分页跳转查询     --%>
            <form id="search" action="/SsmDemo/userQueryUserFundProduct" class="search">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table">
                                ${sessionScope.name}你好
                                <thead>
                                <%-- 标题 --%>
                                <%--             根据UserFundProduct类设计输出                   --%>
                                <tr>
<%--                                    <th scope="col">投资表id</th>--%>
                                    <th scope="col">用户</th>
                                    <th scope="col">基金名称</th>
                                    <th scope="col">起投时间</th>
                                    <th scope="col">结束时间</th>
                                    <th scope="col">投资状态</th>
                                    <th class="text-right" scope="col">操作</th>
                                </tr>
                                </thead>
                                <tbody>
                                <%--items表示为数据源  var表示临时变量--%>
                                <c:forEach items="${list}" var="userFundProductItem">
<%--                                    <c:if test="${userItem.user.username==sessionScope.name}">--%>
                                    <tr>
<%--                                        <th scope="row">${userFundProductItem.id}</th>--%>
                                        <td>${userFundProductItem.user.username}</td>
                                        <td>${userFundProductItem.fundProduct.funddesc}</td>
                                        <td>${userFundProductItem.starttime}</td>
                                        <td>${userFundProductItem.endtime}</td>
<%--                                        <td>${userFundProductItem.status}</td>--%>

                                        <td>
                                            <c:if test="${userFundProductItem.status==1}">
                                               持有中
                                            </c:if>
                                            <c:if test="${userFundProductItem.status==2}">
                                                已失效
                                            </c:if>
                                            <c:if test="${userFundProductItem.status==3}">
                                                已撤销
                                            </c:if>
                                        </td>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="/SsmDemo/toUpdateUserFundProduct?id=${userFundProductItem.id}"> <button class="dropdown-item" type="button">修改</button></a>
                                                    <a href="/SsmDemo/deleteUserFundProduct?id=${userFundProductItem.id}"> <button class="dropdown-item" type="button">删除</button></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
