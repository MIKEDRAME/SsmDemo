...
<%--                    <h5 class="card-title"></h5>--%>
                    <form action="/SsmDemo/updateBank" method="post">
                        <%--          添加id隐藏域              --%>
                        <input type="hidden" name="id" value="${updateBank.id}">
                        <%--          添加id隐藏域              --%>
                        <div class="form-group">
                            <label >银行名称</label>
                            <input type="text" name="name" value="${updateBank.name}" class="form-control"  placeholder="Enter name">
                        </div>
                        <div class="form-group">
                            <label >银行类型</label>
                            <input type="text" name="type" value="${updateBank.type}"  class="form-control"  placeholder="Enter type">
                        </div>
                        <div class="form-group">
                            <label >资产</label>
                            <input type="text" name="assets" value="${updateBank.assets}" class="form-control"  placeholder="Enter assets">

                        </div>
                        <div class="form-group">
                            <label >银行描述</label>
                            <input type="text" name="bankdesc" value="${updateBank.bankdesc}" class="form-control"  placeholder="Enter bankDesc">
                        </div>
