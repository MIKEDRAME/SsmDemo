        ...
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    <li class="breadcrumb-item"><a href="queryUserFundProduct">UserFundProductList</a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/SsmDemo/insertUserFundProduct" method="post">


                            <div class="form-group row">
                                <label for="colFormLabel" class="col-sm-2 col-form-label">用户名称</label>
                                <div class="col-sm-10">
                                    <input type="text" name="userid"  value="${userFundProduct.userid}"
                            ...
                            <div class="form-group row">
                                <label for="CarFormLabelLg"
                                       class="col-sm-2 col-form-label">基金产品</label>
                                <div class="col-sm-10">
                                    <input type="text" name="fundid" class="form-control"
                                           id="CarFormLabelLg"  value="${userFundProduct.fundid}"
                                           placeholder="col-form-label-lg">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabelLg"
                                       class="col-sm-2 col-form-label">起投时间</label>
                                <div class="col-sm-10">
                                    <input type="text" name="starttime" class="form-control"
                                           id="colFormLabelLg" value="${userFundProduct.starttime}"
                                           placeholder="col-form-label-lg">
                                </div>
                            </div>
                                <div class="form-group row">
                                    <label for="colFormLabelLg1"
                                           class="col-sm-2 col-form-label">结束时间</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="endtime" class="form-control"
                                               id="colFormLabelLg1" value="${userFundProduct.endtime}"
                                               placeholder="col-form-label-lg">
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="colFormLabelSm"
                                       class="col-sm-2 col-form-label col-form-label-sm">投资状态</label>
                                <div class="col-sm-10">

                                    <select name="type"name="status" class="form-control form-control-sm"
                                            id="colFormLabelSm">
                                        <option value="1" <c:if test="${userFundProduct.status==1}">selected</c:if>>持有中</option>
                                        <option value="2" <c:if test="${userFundProduct.status==2}">selected</c:if>>已失效</option>
                                        <option value="3" <c:if test="${userFundProduct.status==3}">selected</c:if>>已撤销</option>
                            ...
                            <div class="form-group row">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-lg btn-block btn-uppercase mb-4">添加</button>
