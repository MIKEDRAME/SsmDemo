...
<%--                                               id="colFormLabelLgid" value="${userFundProduct.id}"--%>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="starttime" class="form-control"
                                               ...
                                               placeholder="Enter   starttime，datetime">
                                    </div>
                                </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="endtime" class="form-control"
                                           id="CarFormLabelLg" value="${userFundProduct.endtime}"
                                           placeholder="Enter   endtime，datetime">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="colFormLabelLg"
                                       class="col-sm-2 col-form-label">基金产品id</label>
                                <div class="col-sm-10">
                                    <input type="text" name="fundid" class="form-control"
                                           id="colFormbalance" value="${userFundProduct.fundid}"
                                           placeholder="Enter   fundid，int(10)">
                                </div>
                            </div>
                                <div class="form-group row">
                                    <label for="colFormLabelLg"
                                           class="col-sm-2 col-form-label">用户id</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="userid" class="form-control"
                                               id="colFormbalancel" value="${userFundProduct.userid}"
                                               placeholder="Enter   userid，int(10)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="colFormLabel" class="col-sm-2 col-form-label">投资状态</label>
                                    <div class="col-sm-10">
