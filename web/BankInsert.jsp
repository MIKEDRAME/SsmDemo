    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">银行数据添加</h5>
                        <form action="/SsmDemo/insertBank" method="post">

                            <%--                            --%>
                            <div class="form-group row">
                                <label for="colFormLabelSm"
                                       class="col-sm-2 col-form-label col-form-label-sm">名称</label>
                                <div class="col-sm-10">
                                    <input type="text" name="name" class="form-control form-control-sm"
                                           id="colFormLabelSm"  value="${bank.name}"
                            ...
                            <div class="form-group row">
                                <label for="CarFormLabelLg"
                                       class="col-sm-2 col-form-label">资产</label>
                                <div class="col-sm-10">
                                    <input type="text" name="assets" class="form-control"
                                           id="CarFormLabelLg"  value="${bank.assets}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="test" name="bankdesc" class="form-control"
