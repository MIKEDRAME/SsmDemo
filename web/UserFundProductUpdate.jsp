        ...
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    <li class="breadcrumb-item"><a href="UserFundProductInsert.jsp">Insert</a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/SsmDemo/updateUserFundProduct" method="post">
                            <%--             添加id的隐藏域               --%>
                            <input type="hidden" name="id" value="${userFundProduct.id}">
                            <%--                            --%>
                            <div class="form-group row">
                                <label for="colFormLabelSm"
                                       class="col-sm-2 col-form-label col-form-label-sm">用户名称</label>
                                <div class="col-sm-10">
                                    <input type="text" name="userid" class="form-control form-control-sm"
                                           id="colFormLabelSm"  value="${userFundProduct.userid}"
                                           placeholder="username">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabel" class="col-sm-2 col-form-label">基金产品</label>
                                <div class="col-sm-10">
                                    <input type="text" name="fundid"  value="${userFundProduct.fundid}"
                            ...
                            <div class="form-group row">
                                <label for="CarFormLabelLg"
                                       class="col-sm-2 col-form-label">开始时间</label>
                                <div class="col-sm-10">
                                    <input type="text" name="starttime" class="form-control"
                                           id="CarFormLabelLg"  value="${userFundProduct.starttime}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="endtime" class="form-control"
                                           id="colFormLabelLg" value="${userFundProduct.endtime}"
                                           placeholder="col-form-label-lg">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabelLg1"
                                       class="col-sm-2 col-form-label">投资状态</label>
                                <div class="col-sm-10">
                                    ...
                                    <%--<input type="text" name="leastmoney" class="form-control"
                                           id="colFormLabelLg1" value="${fundProduct.leastmoney}"
                                           placeholder="col-form-label-lg">--%>
                                </div>
                            </div>
